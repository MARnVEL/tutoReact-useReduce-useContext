...
export const formReducer = (state, action) => {
    ...
    //*!Cuando hago los dispatch(), ESTA FUNCIÓN EJECUTA LO QUE TENGO EN EL REDUCER.
    //*Entonces una forma de ver si el reducer está funcionando bien es hacer un clg aquí.
